...
from version_tag_check.version_tag_check_action import (
    VersionTagCheckAction,
    ERROR_TAG_ALREADY_EXISTS,
    ERROR_TAG_DOES_NOT_EXIST,
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("v1.0.0", "false", [Version("v1.0.0")], True, False, 1, ERROR_TAG_ALREADY_EXISTS),                                                    # Existing tag
